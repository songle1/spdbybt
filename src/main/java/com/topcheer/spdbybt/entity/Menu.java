...
public class Menu {
    ...
    public Menu(String accessPath,boolean checked,int delFlag,int parentID,String resourceCode,String resourceDesc
            ,int resourceGrade,int resourceID,String resourceName,int resourceOrder,String resourceType) {
